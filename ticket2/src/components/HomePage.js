...
import RequireLoginWrapper from './common/RequireLoginWrapper';
const HomePage = () => {
    const features = [
        {
    ...
    return (
        <>
            <div className="relative overflow-hidden">
                <div className="inset-0 bg-gradient-to-br from-purple-600 to-blue-500 opacity-10"></div>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                    <div className="text-center">
                        ...
                        <div className="flex justify-center gap-4">
                            <RequireLoginWrapper onClick={() => console.log('Protected action')}>
